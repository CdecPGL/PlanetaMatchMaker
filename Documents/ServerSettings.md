...
|max_credential_bytes|integer (1-15728640)|16384|PMMS_AUTHENTICATION_MAX_CREDENTIAL_BYTES|Maximum Steam ticket or OIDC token size accepted in the authentication message attachment. This setting is limited by the message attachment chunk sequence field.|
